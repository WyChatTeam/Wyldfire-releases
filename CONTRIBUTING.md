# Contributing to Wyldfire

Thank you for your interest in contributing to Wyldfire! 🔥

## Current Status

Wyldfire is currently in **closed development**. The source code is not yet publicly available, but we welcome community feedback and bug reports.
...
- Your operating system and Wyldfire version
...
We plan to open-source Wyldfire in the future. When that happens, we'll update this guide with:
